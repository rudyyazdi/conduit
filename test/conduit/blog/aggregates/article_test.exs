defmodule Conduit.Blog.ArticleTest do
  ...
  describe "publish article" do
    ...
    test "should succeed when valid" do
      ...
      assert_events build(:publish_article, uuid: article_uuid, author_uuid: author_uuid), [
        %ArticlePublished{
          uuid: article_uuid,
  ...
  defp publish_article(_context) do
    ...
    {article, _events, _error} = execute(build(:publish_article, uuid: article_uuid, author_uuid: author_uuid))
