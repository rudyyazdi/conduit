defmodule Conduit.Blog.CommentTest do
  ...
  describe "comment on article" do
    ...
    test "should succeed when valid" do
      ...
      assert_events build(:comment_on_article, uuid: comment_uuid, article_uuid: article_uuid, author_uuid: author_uuid), [
        %ArticleCommented{
          uuid: comment_uuid,
  ...
  describe "delete comment" do
    ...
    test "should succeed when deleted by comment author" do
      ...
      assert_events [
        build(:comment_on_article, uuid: comment_uuid, article_uuid: article_uuid, author_uuid: user_uuid),
    ...
    test "should fail when delete attempted by another user" do
      ...
      assert_error [
        build(:comment_on_article, uuid: comment_uuid, article_uuid: article_uuid, author_uuid: author_uuid),
